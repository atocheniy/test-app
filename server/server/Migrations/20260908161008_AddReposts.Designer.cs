...
namespace server.Migrations
{
    ...
    [Migration("20260908161008_AddReposts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("Bio_FirstLine")
                        .HasColumnType("text");

                    b.Property<string>("Bio_SecondLine")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("server.Models.Message", b =>
                {
                    ...
                    b.HasOne("server.Models.Message", "ReplyTo")
                        .WithMany()
            ...
            modelBuilder.Entity("server.Models.Post", b =>
                {
                    b.HasOne("server.Models.Post", "RepostOfPost")
                        .WithMany()
